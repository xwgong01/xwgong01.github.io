...
and
 ...
 $$\varepsilon^\pm = \frac{(\delta z^\pm_\lambda)^2}{\tau^\pm _{nl}} \Rightarrow  \delta z^\pm_\lambda = (\tilde{\varepsilon}^\pm \lambda)^{1/3}, \tilde{\varepsilon} \equiv \frac{{\varepsilon^{\pm}}^2}{\varepsilon^\mp}$$. 
